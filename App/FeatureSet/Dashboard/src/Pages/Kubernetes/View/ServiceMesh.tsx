    ...
    buildQuery(
      {
        ...
        legend: "Size",
        legendUnit: "",
        metricName: "istio_request_bytes",
        aggregation: AggregationType.Sum,
    ...
    buildQuery(
      {
        ...
        legend: "Size",
        legendUnit: "",
        metricName: "istio_response_bytes",
        aggregation: AggregationType.Sum,
        yAxisFormatter: KubernetesResourceUtils.formatBytesForChart,
      },
      cluster,
    ...
    buildQuery(
      {
        ...
        legend: "Duration",
        legendUnit: "seconds",
        metricName: "pilot_proxy_convergence_time",
        aggregation: AggregationType.Avg,
      },
      cluster,
    ),
    ...
    buildQuery(
      {
        ...
        legend: "Forwarded",
        legendUnit: "pkt/s",
        metricName: "cilium_forward_count",
        aggregation: AggregationType.Sum,
      },
      cluster,
    ),
    buildQuery(
      {
        ...
        legend: "Bytes",
        legendUnit: "",
        metricName: "cilium_forward_bytes",
        aggregation: AggregationType.Sum,
        yAxisFormatter: KubernetesResourceUtils.formatBytesForChart,
      },
      cluster,
    ...
    buildQuery(
      {
        ...
        legend: "Verdicts",
        legendUnit: "",
        metricName: "cilium_policy_l4_filter",
        aggregation: AggregationType.Sum,
      },
      cluster,
    ),
    ...
    buildQuery(
      {
        ...
        legendUnit: "",
        metricName: "cilium_endpoint_regenerations",
        aggregation: AggregationType.Sum,
      },
      cluster,
    ),
    ...
    buildQuery(
      {
        ...
        legend: "Errors",
        legendUnit: "",
        metricName: "cilium_policy_import_errors",
        aggregation: AggregationType.Sum,
      },
      cluster,
    ),
    ...
    buildQuery(
      {
        ...
        legend: "Errors",
        legendUnit: "",
        metricName: "cilium_errors_warnings",
        aggregation: AggregationType.Sum,
      },
      cluster,
    ),
